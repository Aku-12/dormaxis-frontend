        ...
        <div className="grid md:grid-cols-4 gap-12 pb-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-[#4A90B8] transition-all"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#dorms" className="hover:text-white transition-colors">Dorms</a></li>
